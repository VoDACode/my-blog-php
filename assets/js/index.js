        ...
        const addEventsForImage = (root, boxes) => {
            ...
            if (root.getAttribute("edit-mode") != null) {
                for (let i = 0; i < boxes.length; i++) {
                    ...
                    remove.innerHTML = '<img src="assets/img/close.png">';
        ...
        if (files.length > 0) {
            for (let i = 0; i < files.length; i++) {
                ...
                if (file.type.match('image.*')) {
                    ...
                    div.title = file.name;
                    div.innerHTML = `<div class="file-type"><img src="assets/img/file.png"></div><div class="name"><a href="#">${name}</a></div><div class="size"><p>${calcSize(file.size)}</p></div>`;
                    const remove = document.createElement('div');
                    remove.classList.add('remove');
                    remove.innerHTML = '<img src="assets/img/close.png">';
                    remove.addEventListener('click', () => {
